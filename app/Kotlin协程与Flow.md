...
3. [结构化并发](#3-结构化并发)
4. [协程异常处理](#4-协程异常处理)
5. [Flow 基础：冷流](#5-flow-基础冷流)
6. [StateFlow 与 SharedFlow：热流](#6-stateflow-与-sharedflow热流)
7. [Flow 生命周期感知收集](#7-flow-生命周期感知收集)
8. [MVI 架构模式](#8-mvi-架构模式)
9. [协程在 Android 中的最佳实践](#9-协程在-android-中的最佳实践)
10. [面试高频问题](#10-面试高频问题)
11. [AI 交互建议](#11-ai-交互建议)
12. [关联文档](#12-关联文档)
