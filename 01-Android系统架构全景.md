...
> 面向具有 5.5 年 Android 应用开发经验的开发者，系统学习 Framework/OS 内部原理
...
- 阅读 `SystemServer.java` 全文，对照本文档的启动流程
- 结合 [02-Binder与跨进程通信.md](./02-Binder与跨进程通信.md) 理解服务如何注册与查找
- 学习 zygote 启动与 fork 流程，理解进程孵化机制
